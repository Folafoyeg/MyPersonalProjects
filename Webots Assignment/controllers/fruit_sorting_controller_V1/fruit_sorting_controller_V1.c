...
int main(int argc, char **argv) {
  ...
  int counter = 0, i = 0;
  int state = WAITING;
  const double target_positions[] = {-1.57, -1.88, -2.14, -2.38, -1.51};
...
//            printf("Waiting fruit\n");
    ...
    wb_supervisor_set_label(0, strP, 0.01, 0.92, 0.06, 0x55ff00, 0, "Lucida Console");
    
    sprintf(strP, "Apples : %d", apple);
    wb_supervisor_set_label(1, strP, 0.01, 0.96, 0.06, 0x55ff00, 0, "Lucida Console");
